...
#> ✔ Downloading yield curve archive from Bank of England [793ms]
#> 
range(latest$date)
...
#> ✔ Downloading nominal monthly yield-curve archive from Bank of England [40ms]
#> 
head(panel)
...
#> ✔ Downloading inflation monthly yield-curve archive from Bank of England [292ms]
#> 
...
#> ✔ Downloading ois monthly yield-curve archive from Bank of England [187ms]
#> 
