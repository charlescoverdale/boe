...
#> ✔ Downloading yield curve archive from Bank of England [395ms]
#> 
range(latest$date)
#> [1] "2026-05-01" "2026-05-06"
...
#> ✔ Downloading nominal monthly yield-curve archive from Bank of England [48ms]
#> 
head(panel)
...
#> ✔ Downloading inflation monthly yield-curve archive from Bank of England [353ms]
#> 
...
#> ✔ Downloading ois monthly yield-curve archive from Bank of England [183ms]
#> 

mpc <- boe_mpc_decisions(from = "2020-01-01")
#> ℹ Downloading from Bank of England
#> ✔ Downloading from Bank of England [462ms]
#> 
