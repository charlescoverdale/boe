...
#> ✔ Downloading yield curve archive from Bank of England [712ms]
#> 
range(latest$date)
#> [1] "2026-09-01" "2026-09-17"
...
#> ✔ Downloading nominal monthly yield-curve archive from Bank of England [323ms]
#> 
head(panel)
#> # BoE [boe_curve_panel]: 1 series [AS_NOMINAL_SPOT] · 6 obs · 2000-01-31 to 2026-08-28 · freq=monthly
#>         date       m2       m5      m10      m20
...
#> ✔ Downloading ois monthly yield-curve archive from Bank of England [184ms]
#> 

mpc <- boe_mpc_decisions(from = "2020-01-01")
#> ℹ Downloading from Bank of England
#> ✔ Downloading from Bank of England [396ms]
#> 
...
#> 78 2026-07-31 3.877098 4.065922 4.231619 4.339930        NA
#> 79 2026-08-28 3.901343 4.099172 4.271078 4.378089        NA
```
...
head(latest_day)
#> # BoE [boe_curve]: 1 series [AS_OIS_FORWARD_SHORT] · 6 obs · 2026-09-01 to 2026-09-17 · freq=daily
#>           date maturity_years rate_pct
#> 721 2026-09-17     0.08333333 3.747595
#> 722 2026-09-17     0.16666667 3.891507
#> 723 2026-09-17     0.25000000 4.033140
#> 724 2026-09-17     0.33333333 4.169678
#> 725 2026-09-17     0.41666667 4.297432
#> 726 2026-09-17     0.50000000 4.412173
```
