...
#> ✔ Downloading yield curve archive from Bank of England [162ms]
#> 
range(latest$date)
...
#> ✔ Downloading nominal monthly yield-curve archive from Bank of England [44ms]
#> 
head(panel)
...
#> ✔ Downloading inflation monthly yield-curve archive from Bank of England [45ms]
#> 
...
#> ✔ Downloading ois monthly yield-curve archive from Bank of England [26ms]
#> 

mpc <- boe_mpc_decisions(from = "2020-01-01")
#> ℹ Downloading from Bank of England
#> ✔ Downloading from Bank of England [479ms]
#> 
