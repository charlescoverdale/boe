...
#> ✔ Downloading yield curve archive from Bank of England [763ms]
#> 
range(latest$date)
...
#> ✔ Downloading nominal monthly yield-curve archive from Bank of England [42ms]
#> 
head(panel)
...
#> ✔ Downloading inflation monthly yield-curve archive from Bank of England [110ms]
#> 
...
#> ✔ Downloading ois monthly yield-curve archive from Bank of England [64ms]
#> 

mpc <- boe_mpc_decisions(from = "2020-01-01")
#> ℹ Downloading from Bank of England
#> ✔ Downloading from Bank of England [427ms]
#> 
