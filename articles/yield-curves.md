...
#> ✔ Downloading yield curve archive from Bank of England [282ms]
#> 
range(latest$date)
...
#> ✔ Downloading inflation monthly yield-curve archive from Bank of England [31ms]
#> 
...
#> ✔ Downloading ois monthly yield-curve archive from Bank of England [25ms]
#> 
