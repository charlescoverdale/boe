...
Downloads the official Bank Rate (base interest rate) set by the
Monetary Policy Committee. Available as a daily series from January
1975.
...
- frequency:
  ...
  Character. One of `"daily"` (default) or `"monthly"` (monthly
  average).
...
#> ✔ Downloading from Bank of England [679ms]
#> 
...
#> ℹ Downloading from Bank of England
#> ✔ Downloading from Bank of England [217ms]
#> 
#>          date rate_pct
#> 1  2020-01-31   0.7500
#> 2  2020-02-29   0.7500
