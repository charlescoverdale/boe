...
[![R-CMD-check](https://github.com/charlescoverdale/boe/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/charlescoverdale/boe/actions/workflows/R-CMD-check.yaml)
[![Lifecycle:
...
| [`list_exchange_rates()`](https://charlescoverdale.github.io/boe/reference/list_exchange_rates.md)       | Catalogue of available currency codes                      | \-   | \-      |
...
This package is part of a family of R packages for UK economic and
fiscal data. They share a consistent interface - named functions, tidy
data frames, local caching - and are designed to work together. All
outputs join cleanly on date columns.
